...
<!-- Template Stylesheet -->
<link href="${cpath}/resources/css/style.css?qdf" rel="stylesheet">
</head>
...
<body>
   ...
   <!-- Page Header Start -->
    ...
    background-size:cover;">
        <div class="container text-center pt-5 pb-3">
            <h1 class="display-4 animated slideInDown mb-3" id="ATtypo">그림 제출</h1>
      ...
      <div class="image-upload" id="image-upload" style="animation: fadeIn 1s;">
         <form method="post" enctype="multipart/form-data"
            ...
            <div class="button">
               ...
               <h4 style="font-size:20px; color:gray; font-weight:lighter;"> 다시 업로드하려면 그림을 한번 더 클릭해주세요! </h4>
            </div>
            <div class="image-show" id="image-show">
               <div id = "previewImg">
                  <label for="chooseFile">
                     <img src="${cpath}/resources/img/preview1.jpg" id=prevIMG alt="" style = "cursor:pointer;">
                  </label>
               </div>
   ...
   <script>
      ...
      function loadFile(input) {
         ...
         newLabel.setAttribute("for","chooseFile");
         newLabel.setAttribute("style","text-align:center");
         newLabel.setAttribute("display","inline-block;");
         
         var newImage = document.createElement("img");
         newImage.setAttribute("class", 'img');
         newImage.setAttribute("id", 'prevIMG');
         newImage.setAttribute("style", 'width:100%; opacity:1');
         
         var newInput = document.createElement("input");
         newInput.setAttribute("type","file");
         newInput.setAttribute("id","chooseFile");
         newInput.setAttribute("name","chooseFile");
         newInput.setAttribute("accept","image/*");
         newInput.setAttribute("onchange","loadFile(this)");
         
         var newDiv = document.createElement("div");
         newDiv.setAttribute("id","previewImg");
