...
<nav style="position:fixed;" class="navbar navbar-expand-lg navbar-dark fixed-top py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
       ...
       <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav mx-auto p-4 p-lg-0">
                ...
                <c:if test="${empty mvo}">
                <a href="${cpath}/login.do" class="nav-item nav-link" style = "color: #E48B77 !important;">로그인</a>
                </c:if>
                <c:if test="${!empty mvo}">
    ...
    background-size:cover;">
        <div class="container text-center pt-5 pb-3">
            <h1 class="display-4 animated slideInDown mb-3" id="ATtypo">로그인</h1>
    ...
    <!-- 로그인 시작-->
    <div class="logmain">
        <form class="form1" action="${cpath}/select.do">
          ...
          <input name="userpw" class="pass" type="password" align="center" placeholder="비밀번호">
            <div style="text-align:center">
               <a class="loginBtn log"><button type="submit">로그인</button></a>
            </div>
            </form>
        <div style="text-align:center">
            <a class="loginBtn signin"><button onclick='location.href="${cpath}/sign.do"'>회원가입</button></a>
        </div>
        </div>
    <!-- 로그인 끝-->
